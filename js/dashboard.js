...
document.addEventListener('DOMContentLoaded', function() {
    ...
    try {
        ...
        // Fallback: setup basic navigation even if initialization fails
...
function setupBasicNavigation() {
    ...
    navButtons.forEach(button => {
        ...
        button.addEventListener('click', function(e) {
            // Don't handle settings button (it has its own onclick)
...
function createPlantCard(plant) {
    ...
    card.innerHTML = `
        <div class="plant-image">
            <img src="plant-photos/${plant.image || 'snake-plant'}.png" alt="${plant.name}" onerror="this.src='plant-photos/snake-plant.png'">
